 ...
 */
public class bills_view extends javax.swing.JFrame {

    /**
     * Creates new form bills_view
     */
    ...
    public bills_view() {
        ...
        String sql=("call bills3_view();");
        c.viewTable(sql, b_table);
    ...
    private void initComponents() {
        ...
        b_table = new rojeru_san.complementos.TableMetro();
        ...
        rSButtonIconI5.setText("Amount name                          ");
        rSButtonIconI5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jPanel2.add(rSButtonIconI5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 390, 340, 50));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imge/bills.png"))); // NOI18N
        ...
        jPanel1.add(rSButtonMaterialIconTwo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 310, -1, -1));
        ...
        b_table.setColorBackgoundHead(new java.awt.Color(255, 255, 255));
        b_table.setColorForegroundHead(new java.awt.Color(0, 0, 0));
        jScrollPane2.setViewportView(b_table);

        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 370, 1000, 290));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-5, 0, -1, 680));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bills_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bills_view().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private rojeru_san.complementos.TableMetro b_table;
