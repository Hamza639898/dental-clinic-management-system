 ...
 */
public class amount_table extends javax.swing.JFrame {

    /**
     * Creates new form amount_table
     */
    ...
    public amount_table() {
        ...
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
         String sql = "CALL `amounts_view`();";
        dd.viewTable(sql, am_table);
    }
    ...
    private void initComponents() {
        ...
        am_table = new rojeru_san.complementos.TableMetro();
        ...
        jLabel3.setText("Paitent  information");
        ...
        jPanel2.add(rSButtonIconI2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 440, 210, 50));

        rSButtonIconI4.setBackground(new java.awt.Color(0, 0, 102));
        rSButtonIconI4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imge/amount name.png"))); // NOI18N
        rSButtonIconI4.setText("Amount name");
        rSButtonIconI4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jPanel2.add(rSButtonIconI4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 280, 250, 80));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imge/amount 111.png"))); // NOI18N
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, 150, 170));
        ...
        jLabel1.setText("Home / Amount");
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Manage Amounts ");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, -1, -1));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imge/amountname 22.png"))); // NOI18N
        jPanel3.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 0, 200, 210));
        ...
        jPanel1.add(rSButtonMaterialIconTwo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 320, -1, -1));
        ...
        am_table.setColorBackgoundHead(new java.awt.Color(255, 255, 255));
        am_table.setColorForegroundHead(new java.awt.Color(0, 0, 0));
        jScrollPane2.setViewportView(am_table);

        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 370, 990, 320));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(amount_table.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new amount_table().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private rojeru_san.complementos.TableMetro am_table;
