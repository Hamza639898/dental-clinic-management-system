 ...
 */
public class user_taple extends javax.swing.JFrame {
    ...
    public user_taple() {
        ...
        String sql = "CALL `myuser_view`();";
        dd.viewTable(sql, u_table);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "User_Table", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        rSButtonIconI1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imge/doctor_taype.png"))); // NOI18N
        rSButtonIconI1.setText("doctore taype");
        rSButtonIconI1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jPanel3.add(rSButtonIconI1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 460, 210, 50));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Doctores  information");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 280, -1));
        ...
        jPanel3.add(rSButtonIconI4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 140, 50));
        ...
        jPanel3.add(rSButtonIconI3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 130, 50));
        ...
        jPanel3.add(rSButtonIconI5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 390, 130, 50));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imge/user u.png"))); // NOI18N
        ...
        jPanel3.add(rSButtonIconI6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 520, 180, 50));
        ...
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 170, -1));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imge/pass user - Copy.png"))); // NOI18N
        jPanel4.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 270, 210));

        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 80, 980, 210));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel5.setText("Manegment  Systeam");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 0, -1, 50));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imge/tooth (1).png"))); // NOI18N
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 0, -1, -1));
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 20, -1, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel8.setText("Dental clinck ");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 0, -1, 50));

        rSButtonMaterialIconTwo4.setBackground(new java.awt.Color(102, 51, 255));
        rSButtonMaterialIconTwo4.setForeground(new java.awt.Color(0, 0, 0));
        rSButtonMaterialIconTwo4.setText("Add NEW User");
        rSButtonMaterialIconTwo4.setBackgroundHover(new java.awt.Color(67, 150, 209));
        rSButtonMaterialIconTwo4.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.ADD);
        rSButtonMaterialIconTwo4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rSButtonMaterialIconTwo4ActionPerformed(evt);
            }
        });
        jPanel2.add(rSButtonMaterialIconTwo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 330, -1, -1));
        ...
        jScrollPane2.setViewportView(u_table);

        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 400, 730, 290));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1070, 680));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-5, -1, 1070, 680));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(user_taple.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new user_taple().setVisible(true);
            }
        });
    }
