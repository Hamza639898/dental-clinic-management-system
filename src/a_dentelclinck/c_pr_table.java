 ...
 */
public class c_pr_table extends javax.swing.JFrame {
    ...
    public c_pr_table() {
        ...
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
             ...
             String sql = "CALL `customer_prescription_view`();";
    ...
    private void initComponents() {
        ...
        jLabel3.setText(" customer_prescription");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 290, -1));
        ...
        jPanel3.add(rSButtonIconI2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 520, 200, 50));
        ...
        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 320, 650));
        ...
        jLabel1.setText("Home /  customer_prescription");
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Manage  customer_prescription");
        ...
        jPanel4.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 0, 270, 210));
        ...
        jPanel2.add(rSButtonMaterialIconTwo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 310, -1, -1));
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 360, 900, 290));
    ...
    private void rSButtonMaterialIconTwo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconTwo1ActionPerformed
        // TODO add your handling code here:
       customer_prescription_form p=new customer_prescription_form ();
        p.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(c_pr_table.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new c_pr_table().setVisible(true);
            }
        });
    }
